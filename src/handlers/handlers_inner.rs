...
pub async fn create_question(
    ...
    let question = questions_dao
        .create_question(question).await; 
...
pub async fn delete_question(
    ...
    let result = questions_dao
        .delete_question(question_uuid.question_uuid).await; 
...
pub async fn create_answer(
    ...
    match answer {
        ...
        Err(err) => {
            error!("{err}");
            match err {
                DBError::InvalidUUID(msg) => Err(HandlerError::BadRequest(msg)), 
...
pub async fn read_answers(
    ...
    let answers = answers_dao
        .get_answers(question_uuid.question_uuid).await; 
...
pub async fn delete_answer(
    ...
    let result = answers_dao
        .delete_answer(answer_uuid.answer_uuid).await; 
